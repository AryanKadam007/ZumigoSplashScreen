  ...
  return (
    <View className="flex-1 bg-white px-6">
      <ScrollView
        ...
        <TouchableOpacity
          className=" flex-row w-full justify-center items-center bg-white border-2 border-primary  rounded-full py-3 gap-2"
          onPress={() => navigation.navigate(screens.FillAddressDetails)}>
